...
use colossus_terminal::event::{Event, EventListener};
use colossus_terminal::grid::{Dimensions, Grid};
use colossus_terminal::index::{Column, Line};
use colossus_terminal::term::cell::Cell;
use colossus_terminal::term::test::TermSize;
use colossus_terminal::term::{Config, Term};
use colossus_terminal::vte::ansi;
...
fn ref_test(dir: &Path) {
    let recording = read_u8(dir.join("colossus.recording"));
