...
use colossus_terminal::index::Point;
use colossus_terminal::selection::SelectionRange;
use colossus_terminal::term::{LineDamageBounds, TermDamageIterator};
...
/// Iterator which converts `colossus_terminal` damage information into renderer damaged rects.
