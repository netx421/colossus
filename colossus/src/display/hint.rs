...
use colossus_terminal::grid::{BidirectionalIterator, Dimensions};
use colossus_terminal::index::{Boundary, Column, Direction, Line, Point};
use colossus_terminal::term::cell::Hyperlink;
use colossus_terminal::term::search::{Match, RegexIter, RegexSearch};
...
#[cfg(test)]
mod tests {
    use colossus_terminal::index::{Column, Line};
    use colossus_terminal::term::test::mock_term;
    use colossus_terminal::vte::ansi::Handler;
