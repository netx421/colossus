...
use colossus_terminal::event::{EventListener, OnResize, WindowSize};
use colossus_terminal::grid::Dimensions as TermDimensions;
use colossus_terminal::index::{Column, Direction, Line, Point};
use colossus_terminal::selection::Selection;
use colossus_terminal::term::cell::Flags;
use colossus_terminal::term::{
    self, LineDamageBounds, MIN_COLUMNS, MIN_SCREEN_LINES, Term, TermDamage, TermMode,
};
use colossus_terminal::vte::ansi::{CursorShape, NamedColor};
...
impl Display {
    ...
    pub fn draw<T: EventListener>(
        ...
        // Add damage from colossus's UI elements overlapping terminal.
