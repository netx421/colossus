...
use colossus_terminal::event::{Event as TerminalEvent, EventListener, Notify};
use colossus_terminal::event_loop::Notifier;
use colossus_terminal::grid::{BidirectionalIterator, Dimensions, Scroll};
use colossus_terminal::index::{Boundary, Column, Direction, Line, Point, Side};
use colossus_terminal::selection::{Selection, SelectionType};
use colossus_terminal::term::cell::Flags;
use colossus_terminal::term::search::{Match, RegexSearch};
use colossus_terminal::term::{self, ClipboardType, Term, TermMode};
use colossus_terminal::vte::ansi::NamedColor;
...
impl<'a, N: Notify + 'a, T: EventListener> input::ActionContext<T> for ActionContext<'a, N, T> {
    ...
    fn spawn_new_instance(&mut self) {
        ...
        let colossus = env_args.next().unwrap();
        ...
        self.spawn_daemon(&colossus, &args);
    }
