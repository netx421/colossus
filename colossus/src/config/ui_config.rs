...
use colossus_config_derive::{ConfigDeserialize, SerdeReplace};
use colossus_terminal::term::Config as TermConfig;
use colossus_terminal::term::search::RegexSearch;
use colossus_terminal::tty::{Options as PtyOptions, Shell};
...
pub struct UiConfig {
    ...
    /// Config for the colossus_terminal itself.
