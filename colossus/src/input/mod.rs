...
use colossus_terminal::event::EventListener;
use colossus_terminal::grid::{Dimensions, Scroll};
use colossus_terminal::index::{Boundary, Column, Direction, Point, Side};
use colossus_terminal::selection::SelectionType;
use colossus_terminal::term::search::Match;
use colossus_terminal::term::{ClipboardType, Term, TermMode};
use colossus_terminal::vi_mode::ViMotion;
use colossus_terminal::vte::ansi::{ClearMode, Handler};
...
mod tests {
    ...
    use colossus_terminal::event::Event as TerminalEvent;
