...
use colossus_terminal::event_loop::{EventLoop as PtyEventLoop, Msg, Notifier};
use colossus_terminal::grid::{Dimensions, Scroll};
use colossus_terminal::index::Direction;
use colossus_terminal::sync::FairMutex;
use colossus_terminal::term::test::TermSize;
use colossus_terminal::term::{Term, TermMode};
use colossus_terminal::tty;
...
impl WindowContext {
    ...
    pub fn draw(&mut self, scheduler: &mut Scheduler) {
        ...
        if !self.display.visual_bell.completed() {
            // We can get an OS redraw which bypasses colossus's frame throttling, thus
